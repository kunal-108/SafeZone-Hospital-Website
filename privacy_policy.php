...
<body>
    ...
    <div class="container" id="pp">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SafeZone..</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to SafeZone., accessible from <a
                        href="http://localhost/headache/index.php" rel="external nofollow noopener"
                        target="_blank">http://localhost/headache/index.php</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By visiting this page on our website: <a href="http://localhost/headache/contact.php"
                    rel="external nofollow noopener" target="_blank">http://localhost/headache/contact.php</a></li>
        </ul>
    </div>
