...
<head>
    ...
    <title>Privacy Policy - SafeZone</title>
</head>
<body>

    <?php include "header.php" ?>

    <!-- Term and Conditions Section Start -->

    <div class="container" id="tandc">
        <h2><strong>Terms and Conditions</strong></h2>

        <p>Welcome to SafeZone.!</p>

        <p>These terms and conditions outline the rules and regulations for the use of SafeZone.'s Website, located at
            http://localhost/headache/index.php.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use SafeZone.
        ...
        <p>We employ the use of cookies. By accessing SafeZone., you agreed to use cookies in agreement with the
            SafeZone.'s Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, SafeZone. and/or its licensors own the intellectual property rights for all material
            on SafeZone.. All intellectual property rights are reserved. You may access this from SafeZone. for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from SafeZone.</li>
            <li>Sell, rent or sub-license material from SafeZone.</li>
            <li>Reproduce, duplicate or copy material from SafeZone.</li>
            <li>Redistribute content from SafeZone.</li>
        </ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. SafeZone. does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of SafeZone.,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, SafeZone. shall not be liable for the Comments or for any liability, damages
        ...
        <p>SafeZone. reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant SafeZone. a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            SafeZone.; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to SafeZone.. Please include your name, your organization name,
        ...
        <p>No use of SafeZone.'s logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
    ...
    <!-- Term and Conditions Section End -->
